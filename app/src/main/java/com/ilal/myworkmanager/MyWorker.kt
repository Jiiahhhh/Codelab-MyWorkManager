package com.ilal.myworkmanager
...
class MyWorker (context: Context, workerParams: WorkerParameters) : Worker(context, workerParams) {
    ...
    companion object {
        ...
        const val APP_ID = "7b41a6a2eb61052d78849b6b7eb4a05c"
    ...
    private fun getCurrentWeather(city: String?): Result {
        ...
        val url = "https://api.openweathermap.org/data/2.5/weather?q=Makassar&appid=$APP_ID"
        ...
        client.post(url, object : AsyncHttpResponseHandler(){
            ...
            override fun onFailure(
                ...
                showNotification("Get Current Weather Failde", error.message)
                resultStatus = Result.failure()
            }
        })
